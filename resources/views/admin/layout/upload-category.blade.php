                    ...
                    <div class="card-body">
                        <div class=" ml-0 ml-sm-4 ml-sm-0">
                            ...
                            <div class="compose-content">
                                <form action="/admin-upload-kategori-proses" method="post"
                                    enctype="multipart/form-data">
                                    @csrf

                                    <div class="form-group">
                                        <label>Nama Kategori</label>
                                        <input type="text" class="form-control bg-transparent" name="nama">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="text-left mt-4 mb-5">
                                        <button class="btn btn-primary btn-sl-sm" type="submit"><span class="mr-2"><i
                                                    class="fa fa-check" aria-hidden="true"></i></span> Buat
                                            Kategori</button>
                                    </div>
