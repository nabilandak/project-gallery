        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-12 ">
                <div class="login-content">
                    ...
                    <form action="/edit-profile-proses/{{ $dataProfile->id }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="nama">Nama</label>
                            <input type="text" class="form-control text-white" id="nama" name="name"
                                value="{{ $dataProfile->name }}">
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" class="form-control text-white" id="exampleInputEmail1" name="email"
                                value="{{ $dataProfile->email }}">
                        </div>
                        <div class="form-group">
                            <label for="username">Username</label>
                            <input type="text" class="form-control text-white" id="exampleInputEmail1" name="username"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control text-white" name="jenis_kelamin" placeholder="Jenis Kelamin">
                                ...
                                <option value="{{ $dataProfile->jenis_kelamin }}" @if($dataProfile->jenis_kelamin ==
                        ...
                        <div class="d-flex">
                            <a href='/edit-password/{{$dataProfile->id}}' class="btn btn-secondary w-50 mr-2">Ubah Password</a>
                            <button type="submit" class="btn btn-primary w-100 mt-0">Ubah Data Profile</button>
                        </div>
