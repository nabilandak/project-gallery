        ...
        <div class="row">
            <div class="col-sm-3 mb-50">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="/category-detail" class="btn btn-primary col-12">Anime</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mb-50">
                <div class="card">
                    <div class="card-body">
                        <img src="img/images/digital-painting.jpg" class="image-contents">
                        <a href="#" class="btn btn-primary col-12">Digital Painting</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mb-50">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-primary col-12">WPAP</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mb-50">
                <div class="card">
                    <div class="card-body">
                        <img src="img/images/retro.jpg" class="image-contents">
                        <a href="#" class="btn btn-primary col-12">Retro</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3 mb-50">
                <div class="card">
                    <div class="card-body">
                        <img src="img/images/anime.png" class="image-contents">
                        <a href="#" class="btn btn-primary col-12">Anime</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mb-50">
