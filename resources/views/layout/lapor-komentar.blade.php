        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="contact-form-area mt-50">
                    <form action="/lapor-komentar-proses/{{$tampilKomentar->id}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="inputKomentarId" name="komentar_id" value="{{$tampilKomentar->id}}">
                        </div>
                        <div class="form-group">
